...
RColorBrewer::display.brewer.pal(n = 8, name = 'PiYG')

# print the HEX codes of your palette ----
RColorBrewer::brewer.pal(n = 8, name = 'PiYG')

# or save hex codes as a vector ----

color_vector <- RColorBrewer::brewer.pal(n = 8, name = 'PiYG')
```
...
con_color_plot+
  scale_color_distiller(palette = 'BuPu', direction = 1 ) #changes direction
...
pal_d <-  paletteer_d(palette = 'wesanderson::GrandBudapest1', 
                      n = 3)
...
## Step 1:  create palette
pal_c <- paletteer_c("scico::batlow", n = 5, 
                     direction = -1)
