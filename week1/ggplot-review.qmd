...
::: {.callout-note}
This qmd follows the [`{ggplot2}` review slides](https://eds-240-data-viz.github.io/course-materials/lecture-slides/SLIDES-ggplot-review#/title-slide){target="_blank}. Please be sure to cross-reference the slides, which contain important information and additional context!
:::
...
ggplot(penguins, aes(x = bill_length_mm, y = bill_depth_mm, color = species))+
  geom_point()+
  geom_smooth(method = 'lm', fill = "#F7CB15")+
  labs(x = 'Bill Length',
       y = 'Bill Depth',
       color = 'Species')+
  scale_color_manual(values = c('#A44A3F', '#C45AB3', '#76BED0'))+
...
ggplot(penguins, aes(x = bill_length_mm, y = bill_depth_mm, color = body_mass_g)) + 
  geom_point()+
  scale_color_gradient(low =  '#710000', high = "#B3C5D7")+
  labs(x = 'Bill Length',
       y = 'Bill Depth',
       color = 'Body Mass (g)')+
  theme_linedraw()
...
```{r}
histogram <- ggplot(penguins, aes(x = flipper_length_mm, fill = species))+
  geom_histogram(position = 'identity', alpha = .5)+
  scale_fill_manual(values = c('#A44A3F', '#C45AB3', '#76BED0'))+
...
#| message: false
#......................labels & facet wrap.......................
scatter <- ggplot(penguins, aes(x = flipper_length_mm, y = bill_depth_mm, color = species))+
  geom_point()+
  geom_smooth(method = 'lm', fill = "#F7CB15")+
  labs(x = 'Bill Length',
       y = 'Bill Depth',
...
(histogram/scatter)+ 
  plot_annotation(title = 'Pengwang',
