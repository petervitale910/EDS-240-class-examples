...
title <- glue::glue(
  ...
  <br>across the Santa Barbara Coastal Subbasin (2010 - 2020)"
)
#.........................create caption.........................
github_icon <- '&#xf09b'

github_username <- 'petervitale910'
...
#..............................plot..............................
waterplot <- ggplot(sbc_subbasin_monthly) +
  ...
  theme(
    ...
    plot.title = ggtext::element_markdown(family = 'sarala',
                              face = 'bold', 
                              size = rel(0.98), # Relative size
                              color = pal['dark_gray'],
                              lineheight = 1.5) ,
    
    plot.subtitle = element_text(family = 'noto_sans',
                                 size = rel(.9),
                                 color = pal['light_gray'],
                                 margin = margin(b = 8)),
    ...
    axis.title.x = element_text(family = 'noto_sans',
                                size = rel(.75),
                                margin = margin(t = 15)),
    
    axis.title.y = element_blank(),
    plot.caption = ggtext::element_markdown(family = 'noto_sans',
                                face = 'italic',
                                size = rel(.5),
                                color = pal['light_gray'],
                                margin = margin(t = 15)),
